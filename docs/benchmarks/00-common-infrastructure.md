...
Shared contracts for running SciCode and Terminal-Bench 2.1 against the local
...
| Terminal-Bench 2.1 tasks  | Harbor Hub package dataset `terminal-bench/terminal-bench-2-1` | pinned to the immutable content digest `sha256:7d7bdc1cbedad549fc1140404bd4dc45e5fd0ea7c4186773687d177ad3a0699a` (resolved from `@latest` on 2026-07-20; source repo `harbor-framework/terminal-bench-2-1`, org rebranded from `laude-institute`; public dataset needs no `harbor auth login`); record the digest in the ledger                                                                                                                                                                         |
...
- TB 2.1 → the tbench.ai Terminal-Bench 2.1 leaderboard (Terminus-class
